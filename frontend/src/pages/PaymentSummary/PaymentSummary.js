...
function PaymentSummaryPage() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('/api/v1/paymentsummaries');
            const response2 = await axios.post('api/v1/paymentsummaries/sum');
...
<tr style={{backgroundColor: '#add8e6'}}> {/* Light blue background color for the last row */}
<td style={{ padding: '8px', borderBottom: '1px solid #dee2e6' }}>Total</td>
