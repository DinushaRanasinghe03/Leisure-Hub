...
<label htmlFor="email" style={{ fontSize: '20px', marginBottom: '10px' }}>Enter your email address</label>
<input type="email" id="email" placeholder="Enter email" style={{ fontSize: '18px', padding: '15px', width: '100%', borderRadius: '5px', border: '1px solid #ccc' }} value={email} onChange={(e) => { setEmail(e.target.value) }} />
<p style={{ fontSize: '16px' }}>
            We'll never share your email with anyone else.
</p>
</div>
<button onClick={submitData} style={{ fontSize: '20px', padding: '15px 30px', background: '#007bff', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
          Send OTP
</button>
</div>
</div>
